"""Robot de démonstration : inventorie un dossier du workspace et écrit un rapport CSV.

Un exemple de robot « réel » minimal : lit des fichiers, produit une sortie, compte ce qu'il a fait.
"""
...
DESCRIPTION = "Liste les fichiers d'un dossier du workspace et produit un inventaire CSV dans sorties/demo_files/."
SCHEDULE = None
PARAMS = [
